...
| File                                        | Purpose                                                                                                    |
| ------------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| `docker-compose.yml`                        | One compose file launches the full `agent-auth` + `things-bridge` + `things-cli` + fake-AppleScript stack. |
...
| `config.test.yml`                           | Shared test config mounted into the `agent-auth` container.                                                |
