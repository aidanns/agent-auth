...
Structural copy of :mod:`things_bridge.authz` — the validate endpoint
is the same. Kept as its own module so the bridge's error hierarchy and
TLS posture can evolve independently.
"""
...
class AgentAuthClient:
    """Validates bearer tokens against agent-auth's ``/agent-auth/v1/validate``."""
