...
| things-bridge | things-bridge | Configuration Item | HTTP server service that maps /things-bridge/ endpoints to Things 3 AppleScript interactions, delegating token validation to agent-auth. | Delegate Token Validation, Execute External System Interaction, Serve Bridge HTTP API |
