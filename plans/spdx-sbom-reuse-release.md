...
11. ADR `design/decisions/0014-release-supply-chain.md` covering
...
- **Architecture Decision Records** — one ADR (0014) for the
...
5. **Publish workflow** — a single workflow file with jobs
   ...
   as needed.
6. **Documentation** — ADR 0014, SECURITY.md section, CONTRIBUTING
